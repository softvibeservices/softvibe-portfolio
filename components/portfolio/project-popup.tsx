...
export default function ProjectPopup({ project, onClose }: ProjectPopupProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div ref={popupRef} className="card w-full max-w-2xl bg-white dark:bg-[#272829]">
        <div className="relative p-6 md:p-8">
          ...
          <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-6">{project.shortDescription}</p>
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 px-6 py-2.5 border border-gray-300 dark:border-gray-700 text-gray-700 dark:text-gray-300 hover:text-[#7A7FEE] dark:hover:text-[#7A7FEE] hover:border-[#7A7FEE] dark:hover:border-[#7A7FEE] rounded-md transition-all text-sm font-medium"
              onClick={onClose}
            >
